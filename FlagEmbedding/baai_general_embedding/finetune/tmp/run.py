...
from data import TrainDatasetForEmbedding, EmbedCollator, MyIterableDataset, MyEmbedCollator
from modeling import BiEncoderModel, my_modified_BiEncoderModel, my_modified_loss_1_BiEncoderModel
...
def main():
    ...
    if model_args.use_my_modified_loss_model == '0':
    ...
    elif model_args.use_my_modified_loss_model == '1':
    ...
    if model_args.use_my_iter_dataset == '0':
        train_dataset = TrainDatasetForEmbedding(args=data_args, tokenizer=tokenizer)
    elif model_args.use_my_iter_dataset == "1":
        logger.info('use my iter dataset')
        train_dataset = MyIterableDataset(args=data_args, batch_size=20, tokenizer=tokenizer)
    ...
    logger.info('train')
    trainer.train()
    logger.info('begeinging save your  model!!!!!!!!')
