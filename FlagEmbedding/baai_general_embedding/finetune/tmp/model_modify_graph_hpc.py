...
# n_layers mid_size
model_1 = MyModel(4, 16)
model_2 = MyModel(4, 16)
model_3 = MyModel(4, 16)
...
print(f'learnable params :{mix_model.weight_list}')

optimizer = torch.optim.AdamW([{'params': mix_model.weight_list}], 0.1)
